...
export default function SidebarLayout({ children, noPadding = false }: { children: React.ReactNode, noPadding?: boolean }) {
  ...
  return (
    <div className="min-h-screen bg-transparent font-sans flex flex-col relative overflow-hidden">
      ...
      <div className="fixed top-[-10%] right-[-5%] w-[600px] h-[600px] bg-red-400/10 rounded-full mix-blend-multiply filter blur-3xl opacity-50 pointer-events-none"></div>
      <div className="fixed bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-pink-400/10 rounded-full mix-blend-multiply filter blur-3xl opacity-50 pointer-events-none"></div>
      ...
      <div className="sticky top-0 z-50 pt-6 px-6 sm:px-10 max-w-[1600px] w-full mx-auto flex flex-wrap gap-4 items-center">
        ...
        <div 
          ...
          className="flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-tr from-rose-500 to-red-400 cursor-pointer shadow-lg shadow-rose-200 hover:scale-105 transition-transform"
          title="Home"
        >
